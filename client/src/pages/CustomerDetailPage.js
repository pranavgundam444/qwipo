...
function CustomerDetailPage() {
  ...
  const fetchData = () => {
    axios.get(`https://qwipo-jjt5.onrender.com/api/customers/${id}`)
      .then(res => setCustomer(res.data))
      .catch(() => setCustomer({}));
    axios.get(`https://qwipo-jjt5.onrender.com/api/customers/${id}/addresses`)
  ...
  const handleDeleteCustomer = () => {
    ...
    axios.delete(`https://qwipo-jjt5.onrender.com/api/customers/${id}`)
      .then(() => navigate("/"))
  ...
  const handleDeleteAddress = (addressId) => {
    ...
    axios.delete(`https://qwipo-jjt5.onrender.com/api/addresses/${addressId}`)
      .then(() => fetchData())
      .catch(err => alert("Delete failed: " + (err?.response?.data?.error || err.message)));
  };
